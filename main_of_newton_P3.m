...
start_point = 0.05;
%% 求解过程
[root, step, choose, wList] = Newton_P3(max_step, max_f_step, max_x_step, start_point);
%% 结果展示
...
%% 牛顿法迭代流程
function [root, i, choose, wList] = Newton_P3(max_step, max_f_step, max_x_step, start_point)
% 导入方程
[y, yd] = f();
% 计数
i = 1;
...
disp('您提交的 使用三阶牛顿法计算单元方程的根 任务已经接近完成...');
disp('算法执行完毕, 打印结果...');
if choose == 0
