%% Illinois算法 & Pegasus & Anderson & Bjorck
% Write by Zhou Ruihan
% Version: 0.2 Trial V.
% BASIC VERSION: Illinois Method for without deriva.
% What is new: (1) add Pegasus Alg. (2) add A & B Alg.
clear all;
clc;
%% 定义停机准则
% 键入最大迭代步数
...
disp('您提交的 使用illinois算法计算单元方程的根 任务已经接近完成...');
disp('算法执行完毕, 打印结果...');
if choose == 0
